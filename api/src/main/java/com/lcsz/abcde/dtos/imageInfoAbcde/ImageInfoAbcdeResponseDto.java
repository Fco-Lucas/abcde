...
public class ImageInfoAbcdeResponseDto {
    private Long id;
    ...
    public ImageInfoAbcdeResponseDto() {
    }

    public ImageInfoAbcdeResponseDto(Long id, Long lotImageId, String originalName, Integer codigoEscola, Integer ano, Integer grauSerie, String turno, Integer turma, String etapa, Integer prova, String gabarito) {
        this.id = id;
    ...
    public String toString() {
        return "ImageInfoAbcdeResponseDto{" +
                "id=" + id +
